...
Actual data: http://py4e-data.dr-chuck.net/regex_sum_2070614.txt (There are 72 values and the sum ends with 966)
...
Handling The Data
The basic outline of this problem is to read the file, look for integers using the re.findall(), looking for a regular
